...
router.post("/Productos/CrearProducto",CreateProduct)

router.put("/Productos/Edicion/:id/Categoria/:id_Categoria",authRequired,UpdateProduct)

router.delete("/Productos/Eliminar/:id/Categoria/:id_Categoria",authRequired,DeleteProduct) // aca se podría utilizar getproducts para el fronted así traer todos los productos y eliminar el seleccionado por el id de la request
